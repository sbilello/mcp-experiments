...
# --- load_apollo_connectors_docs function  ---
def load_apollo_connectors_docs():
    """
    Load Apollo Connectors documentation from the official website.
    Counts tokens using tiktoken.
    """
    print("Loading Apollo Connectors documentation...")
    urls = [
        "https://www.apollographql.com/docs/federation/connecting-subgraphs/connectors/"
        "https://www.apollographql.com/docs/router/configuration/connectors/", 
        "https://www.apollographql.com/graphos/apollo-connectors",  # Overview & Introduction
        "https://www.apollographql.com/docs/graphos/schema-design/connectors",  # Core Documentation
        "https://www.apollographql.com/docs/graphos/schema-design/connectors/directives",  # Directives
        "https://www.apollographql.com/docs/deploy-preview/a6b98535a5473ca491c3f8c8/graphos/get-started/guides/rest"
    ]
    docs = []
    for url in urls:
    ...
    print(f"Loaded {len(docs)} documents from Apollo Connectors documentation.")
    if docs:
        print("\nLoaded URLs:")
...
def create_vectorstore(splits):
    ...
    persist_path = os.path.join(os.getcwd(), "sklearn_gemini_apollo_vectorstore.parquet")
    try:
...
print("--- Starting Apollo Connectors Documentation Processing ---") # Updated print statement

# Load the documents
loaded_documents, doc_tokens = load_apollo_connectors_docs() # Updated function call
